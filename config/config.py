...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Mrcutex1/Acenew",
)
...
PRIVATE_BOT_MODE_MEM = int(getenv("PRIVATE_BOT_MODE_MEM", 1000))
...
# Images
START_IMG_URL = "https://te.legra.ph/file/c15d01b3e6b40ea141dc9.jpg"
